...
struct param_t {
  ...
  param_t(vertex_t _single_source, vertex_t _num_origin_vertices) : 
  single_source(_single_source), num_origin_vertices(_num_origin_vertices) {}
};
...
struct enactor_t : gunrock::enactor_t<problem_t> {
  ...
  void loop(gcuda::multi_context_t& context) override {
    ...
    auto shortest_path = [distances, single_source, num_origin_vertices] __host__ __device__(
        ...
        weight_t distance_to_neighbor = neighbor >= num_origin_vertices ? source_distance : source_distance+weight;
...
float run(graph_t& G,
  ...
  param_type param(single_source, num_origin_vertices);
